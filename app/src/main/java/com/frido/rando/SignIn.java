    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    // User is signed in
                    Log.d(TAG, "Sign in Class onAuthStateChanged:signed_in:" + user.getUid());
                    Intent intent = new Intent(getApplicationContext(),com.frido.rando.Home.class);
                    Log.d(TAG, "starting home intent");
                    startActivity(intent);

                } else {
                    // User is signed out
                    Log.d(TAG, "Sign in Class  onAuthStateChanged:signed_out");
